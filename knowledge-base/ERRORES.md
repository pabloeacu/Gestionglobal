...
- **Lección / regla:** cuando una consigna define el disparador ("cuando se conoce el vencimiento"), la elegibilidad debe gatear por ESE dato (prox_venc), no por un proxy más estricto (número). Y toda función de fecha derivada debe (a) fijar timezone AR explícito, (b) contemplar el caso "vencido/pasado", (c) usar el último día real del mes. La doble auditoría §6 (revisar + EJERCITAR) los cazó a los 6 antes de prod.
- **Fecha / módulo:** 2026-09-24 · motor de ofrecimientos · Agenda (DGG-200).
