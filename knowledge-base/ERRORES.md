...
- **Verificado:** build limpio + live QA sobre el bundle deployado comparando contra `SELECT saldo FROM cajas_con_saldo` (3.074.548,26 / 880.000,00 / 0) — el card muestra el valor exacto al centavo.
