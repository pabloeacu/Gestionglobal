...
- **Pregunta de negocio para Pablo:** "Curso Integral de formación..." tiene `precio_lista` NULL (29 matrículas, 16 parciales/adeudadas). ¿Es gratis o le falta el precio? Con NULL, el próximo pago de cualquier monto auto-completa. Si debe tener precio → cargarlo (+ re-evaluar esas 16). No se tocó dato.
