...
- **⚑ Para decidir (Pablo):** (a) el servicio PJ viejo listaba $80.000 vs $175.000 del form unificado — hoy PJ paga lo mismo que PF; si corresponde otro precio hay que decirlo; (b) ¿matrícula/legajo RPAC al bloque principal de la máscara del gestor? (hoy van en "Otros datos", igual que antes); (c) ¿columna `cuit_titular_arca` en la ficha del cliente? (hoy vive en la submission y en la máscara del gestor).
