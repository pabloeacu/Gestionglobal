-- ============================================================================
-- Migration: 0111_partner_marcar_facturado_sin_emisor
-- Fecha: 2026-05-28
-- DGG-XX · partner_marcar_facturado ya no exige que el partner tenga
-- emisor_id propio. Valida la visibilidad del comprobante por dos vías:
-- (A) partner.emisor_id = comprobante.emisor_id, o
-- (B) existe movimiento de cobranza con partner_id_atribucion = partner.
-- Esto soporta el caso común de partners que sólo participan por convenio.
-- ============================================================================
