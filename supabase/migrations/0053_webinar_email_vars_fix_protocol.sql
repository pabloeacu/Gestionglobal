-- 0053 · fix protocolo en link_acceso de webinars.
-- config_global.sitio_web está guardado como "gestionglobal.ar" sin https://,
-- entonces los emails salían con un link no clickeable. Forzamos https://.
-- (Reemplazado por 0054 que además fija fecha en español.)
